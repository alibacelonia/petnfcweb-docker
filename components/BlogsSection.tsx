        ...
        <div className="w-full sm:w-1/2 sm:pr-10">
          <div className="relative pt-4 mx-auto me-md-0">
            <div className="flex flex-col">
              ...
              <h1 className="light:text-slate-700 font-semibold text-2xl sm:text-4xl  leading-normal  text-slate-700">
              ...
              <div className="flex flex-row mt-4 gap-3">
                <div className="shrink-0 py-1 pr-3 border-r-2 border-slate-300">
                  <h4 className="font-medium light:text-slate-700">
                    12 hours ago
                  </h4>
                </div>
                <div className="shrink-0 py-1 flex flex-row justify-center items-center ">
                  <HiOutlineThumbUp
                    size={20}
                    className=" light:text-slate-700 "
                  ></HiOutlineThumbUp>
                  <span className="text-sm font-medium light:text-slate-700 ">
                    100
                  </span>
                </div>
                <div className="shrink-0 py-1 flex flex-row justify-center items-center ">
                ...
                <div className="shrink-0 py-1 flex flex-row justify-center items-center ">
                  <HiOutlineShare
                    size={20}
                    className=" light:text-slate-700 0"
                  ></HiOutlineShare>
                  <span className="text-sm font-medium light:text-slate-700 ">
                    100
                  </span>
